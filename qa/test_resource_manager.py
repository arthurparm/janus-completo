def test_budget_usage_and_priority():
    from app.services.resource_manager import can_schedule_training, record_training_usage, get_user_gpu_usage, compute_job_priority
    uid = "u1"
    ...
    assert compute_job_priority(uid, "classifier") in (2, 3, 4, 5)