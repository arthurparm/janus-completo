...
**Evidências:**
- `backend/app/api/v1/endpoints/auth.py` and memory context rules indicam que defaults to NOT returning the token ... but remains a potential leak risk se habilitado.
