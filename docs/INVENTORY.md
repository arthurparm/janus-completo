...
Este documento detalha o levantamento técnico dos componentes do Janus, incluindo rotas de API, serviços, e dívidas técnicas identificadas durante a fase de análise.
