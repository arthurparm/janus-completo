...
> *Detailed system listings, surveys, and maintenance tasks.*
...
- Detailed Surveys (Annexes)
  ...
  - Batch 3 — Services (In Progress)
  - Batch 4 — Repositories (In Progress)
  - Batch 5 — Agents (In Progress)
...
* [ ] **Structural Infra — Processes & Resilience** (new)
  ...
  * [ ] **Neo4j reconnect**: implement reconnect/health gating when the driver goes offline, preventing getting stuck until restart.
...
*Detailed tables omitted for brevity, please refer to source code or generate via Swagger/OpenAPI.*
...
**Objective**: map the service layer and explicit critical pending items in Janus's heart flow.
