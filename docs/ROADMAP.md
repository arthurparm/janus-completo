...
Practical criteria:
- **Throughput**: Well-defined changes, mechanical, low risk (good for Mini).
...
* [ ] **FrugalGPT (LLM Cascades)** - *Chen et al., 2023*
  ...
  * **In Janus**: `ModelRouter` in infrastructure that tries to solve with Llama-3-Locall/Mini before calling DeepSeek/GPT-4.
* [ ] **DSPy (Programming with Prompts)** - *Khattab et al., 2023*
  ...
  * **In Janus**: Pipeline for self-tuning Workers' prompts based on error/success feedback.
...
* **OpenAI Data Sharing (Complimentary Tokens)**:
  ...
  * **The "Nightmare" Risk**: All Janus code, prompts, and strategies become OpenAI training property. If Janus creates something innovative, OpenAI learns.
...
* [ ] **UX Improvements**:
  ...
  * Friendly error handling.
  ...
  - [ ] Normalize error messages coming from API (Problem+JSON) to UI.
