...
| GET | `/api/v1/observability/health/components/llm_manager` | Observability | N/A | no |
...
| POST | `/api/v1/productivity/oauth/google/legacy/callback` | Productivity | N/A | yes |
| POST | `/api/v1/productivity/oauth/google/legacy/refresh` | Productivity | N/A | yes |
