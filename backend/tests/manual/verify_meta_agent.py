...
sys.modules["app.core.llm.router"] = MagicMock()
mock_llm_router = sys.modules["app.core.llm.router"]
mock_llm_router.get_llm.return_value = MagicMock()
mock_llm_router.ModelRole = MagicMock()
mock_llm_router.ModelPriority = MagicMock()
