...
class AppSettings(BaseSettings):
    ...
    AUTONOMY_SELF_STUDY_PERIODIC_ENABLED: bool = True
    AUTONOMY_SELF_STUDY_PERIODIC_INTERVAL_SECONDS: int = 21600
    ...
    CHAT_CITATION_TIMEOUT_SECONDS: float = 3.0
    CHAT_STUDY_JOB_LEASE_SECONDS: int = 300
    CHAT_REST_RUN_LEASE_SECONDS: int = 300
    CHAT_REST_RUN_RETENTION_HOURS: int = 24
    CHAT_REST_RUN_CLEANUP_INTERVAL_SECONDS: int = 3600
