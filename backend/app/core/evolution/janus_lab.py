...
class JanusLabManager:
    ...
    def spawn_lab(
        ...
        try:
            ...
            container = self.client.containers.run(
                ...
                environment=lab_env,
                volumes={lab_workspace: {"bind": "/app/lab_workspace", "mode": "rw"}},
    ...
    def run_test_in_lab(self, lab_id: str, test_command: str, timeout: int = 60) -> LabResult:
        ...
        try:
            ...
            exec_result = container.exec_run(
                cmd=["sh", "-c", test_command], workdir="/app", environment={"PYTHONPATH": "/app"}
            )
            ...
            result = LabResult(
                ...
                metrics={"exit_code": exit_code, "duration_seconds": duration},
    ...
    def run_python_in_lab(self, lab_id: str, python_code: str) -> LabResult:
        """
    ...
    def _generate_lab_env(self, custom_env: dict[str, str] | None = None) -> dict[str, str]:
