...
class DataHarvester:
    ...
    async def _run_connector_loop(self, connector: IHarvesterConnector) -> None:
    ...
    async def _process_items(self, items: list[dict[str, Any]]) -> None:
...
async def harvest_data_for_training(
    ...
    try:
        ...
        memory_repo = MemoryRepository(cast(MemoryDBProtocol, memory_db))
