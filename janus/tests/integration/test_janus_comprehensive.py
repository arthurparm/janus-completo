...
class TestOSTools:
    ...
    async def test_read_write_system_file(self):
        ...
        try:
            ...
            print(f"✓ read/write_system_file working correctly")
        finally:
            os.unlink(test_path)
    ...
    async def test_execute_system_command_error_handling(self):
        ...
        print(f"✓ execute_system_command handles errors gracefully")
...
class TestMetaAgentRemediation:
    ...
    async def test_proactive_remediation_dispatches_task(self, mock_broker):
        ...
        from app.core.agents.meta_agent import MetaAgent, StateReport, Recommendation
...
class TestAgentToolFiltering:
    ...
    async def test_sysadmin_has_dangerous_tools(self):
        ...
        from app.core.agents.multi_agent_system import SpecializedAgent, AgentRole, SharedWorkspace
        from app.core.tools.action_module import PermissionLevel
...
class TestWorkspaceTaskManagement:
    ...
    def test_task_lifecycle(self):
        ...
        from app.core.agents.multi_agent_system import SharedWorkspace, Task, TaskStatus, TaskPriority
...
class TestPromptLoader:
    ...
    def test_prompt_loader_initialization(self):
        ...
        from app.core.infrastructure.prompt_loader import prompt_loader, get_prompt
...
class TestActionModule:
    ...
    def test_tool_categories_exist(self):
        ...
        from app.core.tools.action_module import ToolCategory, PermissionLevel
...
class TestHealthMonitor:
    ...
    async def test_health_monitor_functions(self):
        ...
        try:
            from app.core.monitoring.health_monitor import record_latency, get_health_summary
...
class TestFaultyTools:
    ...
    def test_faulty_tools_exist(self):
        ...
        from app.core.tools.faulty_tools import get_faulty_tools, faulty_tools
...
class TestLLMFactory:
    ...
    def test_llm_types(self):
        ...
        from app.core.llm.types import ModelRole, ModelPriority, ProviderStats
...
class TestMultiAgentSystemDispatch:
    ...
    async def test_dispatch_task_creates_message(self):
        ...
        from app.core.agents.multi_agent_system import MultiAgentSystem, Task, AgentRole
