...
from app.core.agents.multi_agent_system import MultiAgentSystem, AgentRole, Task, TaskStatus, TaskPriority
...
async def test_end_to_end_project_flow(tmp_path):
    ...
    pm_response = """
    Thought: I need to create a task for the Coder.
    Action: create_task_tool
    Action Input: {
    ...
    with patch("app.core.infrastructure.message_broker.get_broker", new=AsyncMock(return_value=mock_broker)), \
         ...
         patch("app.core.agents.multi_agent_system.get_llm") as mock_get_llm, \
