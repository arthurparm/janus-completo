...
from app.core.memory.circuit_breaker_monitoring import (
    CircuitBreakerAlertManager, CircuitBreakerAnalytics, CircuitBreakerMonitoringService,
    CircuitBreakerAlert, AlertSeverity, CircuitBreakerMetricsSnapshot
)
...
class TestCircuitBreakerIntegration:
    ...
    async def test_circuit_breaker_health_check(self):
        ...
        from app.core.memory.circuit_breaker_monitoring import CircuitBreakerMonitoringService
...
def mock_memory_core():
    ...
    class MockMemoryCore:
        ...
        def force_circuit_open(self):
            ...
            print(f"Forced circuit breaker to OPEN state")
        
        def reset_circuit_breaker(self):
            """Reset the circuit breaker to closed state."""
            self._cb.reset()
            print(f"Reset circuit breaker to CLOSED state")
