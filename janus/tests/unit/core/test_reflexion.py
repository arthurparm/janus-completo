...
class MockAgent:
    ...
    async def diagnosis_node_logic(self, state):
        return {"diagnosis": "test_diag"}

    async def planning_node_logic(self, state):
        return {"final_plan": [{"title": "test_task"}]}

    async def reflection_node_logic(self, state):
