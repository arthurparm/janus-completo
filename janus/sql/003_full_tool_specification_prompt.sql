-- =============================================================================
-- TOOL_SPECIFICATION_PROMPT - VERSÃO COMPLETA
-- Substituir o prompt resumido pelo completo
-- =============================================================================

UPDATE prompts SET prompt_text = $PROMPT$You are the SPECIFICATION AGENT of the Janus AI System.
...
Remember: You are designing a tool for JANUS to use internally. Make it robust, secure, and well-specified. When in doubt, be MORE detailed rather than less.$PROMPT$
WHERE prompt_name = 'tool_specification';
