...
class MemoryRepository:
    ...
    async def search_experiences(
        ...
        logger.debug(
            "Buscando experiências no repositório de memória",
            query=query,
            limit=limit,
            min_score=min_score,
        )
    ...
    async def search_filtered(
        ...
        logger.debug(
            "Busca filtrada no repositório de memória",
            query=query,
            filters=filters,
            limit=limit,
            min_score=min_score,
        ...
        try:
            return await self._db.arecall_filtered(
    ...
    async def search_by_timeframe(
        ...
        try:
            return await self._db.arecall_by_timeframe(
                query=query,
                start_ts_ms=start_ts_ms,
                end_ts_ms=end_ts_ms,
                limit=limit,
    ...
    async def search_recent_failures(
        ...
        try:
            return await self._db.arecall_recent_failures(
    ...
    async def search_recent_lessons(
        ...
        try:
            return await self._db.arecall_recent_lessons(
                limit=limit, timeframe_seconds=timeframe_seconds, min_score=min_score
            )
        except Exception as e:
