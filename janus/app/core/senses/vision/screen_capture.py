...
class ScreenCaptureService:
    ...
    def __init__(self, max_width: int = 800, quality: int = 85):
        ...
        if not PIL_AVAILABLE:
            ...
            logger.info(
                "ScreenCaptureService initialized",
                max_width=max_width,
                quality=quality
            )
    
    async def capture_active_window(self) -> Optional[ScreenCapture]:
        """
    ...
    def _capture_active_window_sync(self) -> Optional[ScreenCapture]:
    ...
    async def capture_full_screen(self) -> Optional[ScreenCapture]:
        """
    ...
    def _capture_full_screen_sync(self) -> Optional[ScreenCapture]:
...
# Singleton instance
_capture_instance: Optional[ScreenCaptureService] = None
