...
from qdrant_client.models import SearchRequest, Filter, SearchParams
    ...
    async def _execute_with_retry(self, 
        ...
        for attempt in range(config.max_attempts):
            try:
                ...
                last_exception = QdrantConnectionError(f"{operation} failed: {str(e)}")
                logger.warning(
        ...
        try:
            ...
            if collection_name:
                try:
                    ...
                    logger.warning(
                        "qdrant_collection_not_found_health_check",
                        collection_name=collection_name
                    )
                    return False
