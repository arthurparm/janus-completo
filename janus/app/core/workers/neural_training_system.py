...
try:
    ...
    _TRAINING_JOBS = REGISTRY._names_to_collectors["neural_training_jobs_total"]  # type: ignore
...
try:
    ...
    _TRAINING_LATENCY = REGISTRY._names_to_collectors["neural_training_latency_seconds"]  # type: ignore
...
try:
    ...
    _MODEL_ACCURACY = REGISTRY._names_to_collectors["neural_model_accuracy"]  # type: ignore
...
try:
    ...
    _TRAINING_EXAMPLES = REGISTRY._names_to_collectors["neural_training_examples_count"]  # type: ignore
