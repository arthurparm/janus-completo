...
class OptimizationService:
    ...
    def update_agent_prompt(
        ...
        try:
            ...
            version_number = getattr(version_obj, "version", None) or getattr(version_obj, "version_number", None)
            activated = False
            ...
            logger.error("Falha ao atualizar prompt do agente", role=role.value, prompt_name=prompt_name, error=str(e))
