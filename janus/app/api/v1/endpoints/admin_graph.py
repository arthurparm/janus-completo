...
async def purge_incompatible_threads(force: bool = False, background_tasks: BackgroundTasks = None):
    """
...
async def get_contextual_graph(
    query: str | None = None, conversation_id: str | None = None, limit: int = 50, hops: int = 1
):
    """
