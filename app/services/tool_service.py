...
from app.repositories.tool_repository import tool_repository, ToolRepositoryError
...
class ToolService:
    ...
    def list_tools(self, category: Optional[ToolCategory], permission_level: Optional[PermissionLevel],
        ...
        return tool_repository.find_all(category, permission_level, tags)
    ...
    def get_tool_details(self, tool_name: str) -> ToolMetadata:
        ...
        metadata = tool_repository.find_by_name(tool_name)
        if not metadata:
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return tool_repository.get_all_statistics()
    ...
    def create_tool_from_function(self, request_data: Dict[str, Any]) -> ToolMetadata:
        ...
        try:
            # Lógica de negócio: criar o objeto da ferramenta
            ...
            # Lógica de persistência: delegar para o repositório
            metadata_to_save = {
            ...
            tool_repository.save(tool, metadata_to_save)
    ...
    def delete_tool(self, tool_name: str):
        ...
        # Verifica se a ferramenta existe antes de tentar remover
        self.get_tool_details(tool_name)

        tool_repository.delete(tool_name)
        logger.info("Ferramenta removida com sucesso via serviço", tool_name=tool_name)

    def list_categories(self) -> List[str]:
        return tool_repository.get_all_categories()

    def list_permissions(self) -> List[str]:
        return tool_repository.get_all_permissions()
