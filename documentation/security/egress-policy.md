...
- Implementação: [enforce_tool_http_egress](../../backend/app/core/security/egress_policy.py)
- Requisitos:
...
- Implementação: [enforce_worker_http_egress](../../backend/app/core/security/egress_policy.py)
- Política:
...
- Modelo: [AuditLedgerEvent](../../backend/app/models/audit_ledger_models.py#L9-L41)
