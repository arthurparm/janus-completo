...
- Matriz de rastreabilidade (internal-only): [compliance-traceability-matrix.json](../../documentation/compliance/compliance-traceability-matrix.json)
- DPIA/LIA simplificado (internal-only): [dpia-lia-internal.md](../../documentation/compliance/dpia-lia-internal.md)
