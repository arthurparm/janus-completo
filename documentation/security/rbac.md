...
- Implementação: [require_admin_actor](../../backend/app/core/security/request_guard.py)
- Regra:
...
- Implementação: [require_same_user_or_admin](../../backend/app/core/security/request_guard.py)
- Regra:
...
- Deployment: [deployment.py](../../backend/app/api/v1/endpoints/deployment.py)
- Users (assign_role): [users.py](../../backend/app/api/v1/endpoints/users.py) (role SYSTEM é reservado e não pode ser atribuído via API)
- Resources (GPU budgets): [resources.py](../../backend/app/api/v1/endpoints/resources.py)

## Evidências automatizadas

- Testes unitários: [test_security_request_guard_rbac.py](../../backend/tests/unit/test_security_request_guard_rbac.py)
