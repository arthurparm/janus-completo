...
Implementação: [security.py](../../backend/app/core/memory/security.py)
...
- Cliente: [vault_client.py](../../backend/app/core/infrastructure/vault_client.py)
- Rotação (job): [scheduler_service.py](../../backend/app/services/scheduler_service.py)
...
Implementação: [secret_memory_service.py](../../backend/app/services/secret_memory_service.py)
...
- Serviço: [secret_key_rotation_service.py](../../backend/app/services/secret_key_rotation_service.py)
- Job: [scheduler_service.py](../../backend/app/services/scheduler_service.py)
...
Modelo: [AuditLedgerEvent](../../backend/app/models/audit_ledger_models.py)
