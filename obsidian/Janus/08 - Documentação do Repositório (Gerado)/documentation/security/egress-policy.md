---
gerado: true
origem: "documentation/security/egress-policy.md"
...
- Requisitos:
  ...
  - toda tentativa bloqueada gera evidência em `audit_events` (quando DB disponível)
...
- Bloqueios geram `audit_events` com `endpoint=egress_policy` e `action=egress_blocked`.
